...
urlpatterns = [
    ...
    path('approvequestionans/', views.approvequestionans_view, name="approvequestionans"),
    path('approvedquestionans/<int:id>/', views.approvedquestionans_view, name="approvedquestionans"),
    ...
    path('disapprovequestionans/<int:id>/', views.disapprovequestionans_view, name="disapprovequestionans"),
